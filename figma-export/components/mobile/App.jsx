...
function App() {
  return (
    <Router>
      <Switch>
        <Route path="/:path(|mobile-responsive-components)">
          <MobileResponsiveComponents {...mobileResponsiveComponentsData} />
        </Route>
        <Route path="/web-components">
          <div className="container-center-horizontal">
            <div className="web-components screen">
              <NavBar2>
                <LogoSearch />
                <Text />
                <IconButton
                  iconTwitterProps={iconButtonData.iconTwitterProps}
                  iconTwitter32Props={iconButtonData.iconTwitter32Props}
                  ...
                  iconTwitter62Props={iconButtonData.iconTwitter62Props}
                />
              </NavBar2>
              <NavBar1>
                ...
                <IconButton
                  ...
                  iconTwitter32Props={iconButton2Data.iconTwitter32Props}
                  ...
                  iconTwitter62Props={iconButton2Data.iconTwitter62Props}
                />
              </NavBar1>
              ...
              <FlexRow>
                <FlexCol>
                  ...
                  <FlexRow1>
                    <FlexCol1>
                      <IconTwitter iconTwitter2Props={iconTwitter7Data.iconTwitter2Props} />
                      <FlexRow2>
                        <IconTwitter22 src="/img/vector@2x.svg" className="icon-mode-2" />
                        <IconInstagram src="/img/group-1@2x.svg" className="icon-instagram-2" />
                        <IconShare src="/img/group-2@2x.svg" className="icon-share-2" />
                        <IconDiscord src="/img/group@2x.svg" className="icon-discord-4" />
                        <IconMode src="/img/group-3@2x.svg" className="icon-mode-3" />
                        <IconMode src="/img/icon---search@2x.svg" className="icon-search-4" />
                        <IconHamburgerManu src="/img/icon---menu@2x.svg" className="icon-hamburger-manu-1" />
                      ...
                      <FlexRow3>
                        ...
                        />
                        <ButtonOtherActive buttonOtherActive="/img/button---other-active@2x.svg" create="Create Item" />
                      </FlexRow3>
                      <FlexRow4>
                        <ButtonMain2 className="button-main-5">Connect wallet</ButtonMain2>
                  ...
                  <FlexCol2>
                    <ButtonLoad iconRefresh="/img/icon---refresh@2x.svg" loadMoreItems="Load more items" />
                    <InputFieldDropDown
                    ...
                    <FlexRow7>
                      <FlexCol3>
                        <ProfileCard1
                          ...
                          balance="Balance"
                        />
                        <ProfileTabActive profileTabActive="/img/rectangle-133@2x.svg" myItems="/img/my-items@2x.svg" />
                        <ProfileTabDefult editProfile="Edit Profile" rectangle133="/img/rectangle-133@2x.png" />
                      </FlexCol3>
                      <PopProfileDropdown
...
const mobileInputFieldSimpleDescriptionData = {
    ...
    text2: "When an unknown printer took a galley of type and scrambled it to make a type specimen book. And scrambled it to make a type specimen book. It has survived not only five centuries.",
};
...
const mobileInputFieldSimpleRoyaltiesData = {
    ...
    number: "20",
    text5: "%",
    text6: <>Suggested: 0%, 10%, 20%, 30%, <br />Maximum is 50%</>,
};
