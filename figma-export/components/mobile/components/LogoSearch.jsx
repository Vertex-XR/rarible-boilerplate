...
import { Border1pxButtonSecondary, MontserratMediumMonsoon14px } from "../../styledMixins";
  ...
  return (
    <LogoSearch1 className={`logo-search ${className || ""}`}>
      ...
      <OverlapGroup className="overlap-group-10">
        <IconSearch className="icon-search-5" src="/img/icon---search@2x.svg" />
        <Text14 className="text-14">Collection, item or user</Text14>
      </OverlapGroup>
    </LogoSearch1>
  );
}
